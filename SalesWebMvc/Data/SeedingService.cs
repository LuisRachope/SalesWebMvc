...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            // Creation Departments to migration on DB
            Department d1 = new Department(1, "Computers");
            Department d2 = new Department(2, "Electronics");
            Department d3 = new Department(3, "Fashion");
            Department d4 = new Department(4, "Books");

            // Creation Sellers to migration on DB
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1979, 12, 31), 3500.0, d2);
            Seller s3 = new Seller(3, "Alex Grey", "alex.green@gmail.com", new DateTime(1988, 1, 15), 2200.0, d1);
            ...
            // Creation SalesRecord to migration on DB
            ...
            // Adding departments on DB
            _context.Department.AddRange(d1, d2, d3, d4);

            // Adding sellers on DB
            _context.Seller.AddRange(s1, s2, s3, s4, s5, s6);

            // Adding salesrecords on DB
